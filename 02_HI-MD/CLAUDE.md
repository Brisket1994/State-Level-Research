# Student Transportation Contract Rules — Set 2 (HI–MD): Fan-Out Research Orchestrator
...
for the ten HI–MD states across the five fields), the neutral-recorder posture, and that each state was researched
...
- **Hawaii** — Primary citation: <official URL> · Source-validation: <verified/partially/not/unreachable> · Adversarial verdict: <confirmed/refuted/unresolved> · Confidence: <High/Medium/Low>
...
const STATES = ['Hawaii','Idaho','Illinois','Indiana','Iowa','Kansas','Kentucky','Louisiana','Maine','Maryland']
