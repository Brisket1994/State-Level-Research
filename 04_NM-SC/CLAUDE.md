# Student Transportation Contract Rules — Set 4 (NM–SC): Fan-Out Research Orchestrator
...
for the ten NM–SC states across the five fields), the neutral-recorder posture, and that each state was researched
...
- **New Mexico** — Primary citation: <official URL> · Source-validation: <verified/partially/not/unreachable> · Adversarial verdict: <confirmed/refuted/unresolved> · Confidence: <High/Medium/Low>
...
const STATES = ['New Mexico','New York','North Carolina','North Dakota','Ohio','Oklahoma','Oregon','Pennsylvania','Rhode Island','South Carolina']
