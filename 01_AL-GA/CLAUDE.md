# Student Transportation Contract Rules — Set 1 (AL–GA): Fan-Out Research Orchestrator
...
**States — exactly these ten. This list is the single point of change when porting the orchestrator to batches
`02_HI-MD` … `05_SD-WY-DC`:**
...
for the ten AL–GA states across the five fields), the neutral-recorder posture, and that each state was researched
...
- **Alabama** — Primary citation: <official URL> · Source-validation: <verified/partially/not/unreachable> · Adversarial verdict: <confirmed/refuted/unresolved> · Confidence: <High/Medium/Low>
